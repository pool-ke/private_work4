...
#import CAE_modelread_paper01 as df
...
class Image_Process(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        self.buttonProcess5=QtWidgets.QPushButton(u"save",self)
        self.buttonProcess5.move(1040,18)
        self.buttonProcess5.clicked.connect(self.img_process5)
...
#        temp=imgPath+self.allFiles.currentItem().text()
    ...
    def itemClick1(self):
        ...
        self.labelImg1.setPixmap(qImgT)
        self.labelscore.setText("the score is %.2f"%(self.scoredata[temp]))
...
#        self.labelImg2.setPixmap(qImgT)
    def img_process2(self):
        ...
        img3=sm.opening(self.img_contrast,sm.square(4))
        height=img3.shape[0]
    ...
    def img_process5(self):
        print ("1111")
        filetemp1="paperthing/"+"Original_"+self.allFiles.currentItem().text()
        filetemp2="paperthing/"+"Model_"+self.allFiles.currentItem().text()
        filetemp3="paperthing/"+"Processed_"+self.allFiles.currentItem().text()
        cv.imwrite(filetemp1,self.imgOri)
        cv.imwrite(filetemp2,self.model)
        cv.imwrite(filetemp3,self.img_processed)
