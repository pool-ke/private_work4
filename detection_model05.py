...
#        self.axes.vlines(X_line2,0,100,colors='red',linestyles="dashed")
    def test(self,X_line1=0.5):
        X=np.linspace(0,1,101,endpoint=True)
        Y=np.ones(len(X))
        self.axes.plot(X,Y)
        self.axes.vlines(X_line1,0,2,colors='red',linestyles="dashed")
...
#        self.buttonVisualize.clicked.connect(self.img_visualize)
        ...
        self.buttonProcess2=QtWidgets.QPushButton(u"Save",self)
        ...
        self.label3=QtWidgets.QLabel(u'SampleList(OK)',self)
        self.label3.move(610,50)
        self.allFiles2=QtWidgets.QListWidget(self)
        self.allFiles2.move(600,70)
        self.allFiles2.resize(120,400)
        
        self.label4=QtWidgets.QLabel(u'SampleList(NG)',self)
        self.label4.move(810,50)
        self.allFiles3=QtWidgets.QListWidget(self)
        self.allFiles3.move(800,70)
        self.allFiles3.resize(120,400)
...
#        print (self.allFiles.count())
        ...
        self.allFiles3.itemClicked.connect(self.itemClick3)
...
#        
#        self.labelscore=QtWidgets.QLabel("the score is %.2f"%(0),self)
#        self.labelscore.move(200,780)
#        self.labelscore.resize(200,25)
#        
#        
...
#        temp=imgPath+self.allFiles.currentItem().text()
    ...
    def itemClick1(self):
        ...
        temp1=temp.split('/')[-1]
        print(temp1)
        self.img_currentfilename=temp1
        print (self.img_currentfilename)
    ...
    def itemClick2(self):
        temp="QTGUIList/"+self.allFiles2.currentItem().text()
#        temp=imgPath+self.allFiles.currentItem().text()
        self.img_currentfilename=self.allFiles2.currentItem().text()
        qImgT=QtGui.QPixmap(temp)
        self.labelImg1.setPixmap(qImgT)
        self.index=2
    def itemClick3(self):
        temp="QTGUIList/"+self.allFiles3.currentItem().text()
#        temp=imgPath+self.allFiles.currentItem().text()
        self.img_currentfilename=self.allFiles3.currentItem().text()
        qImgT=QtGui.QPixmap(temp)
        self.labelImg1.setPixmap(qImgT)
        self.index=2
...
#        print (type(json.load(f)))
    ...
    def img_process3(self):
        temp1="QTGUISample/"+self.img_currentfilename
        temp2="QTGUIList/"+self.img_currentfilename
        if self.index==1:
            qImgT=QtGui.QPixmap(temp2)
            self.labelImg1.setPixmap(qImgT)
            self.index=2
        else:
            qImgT=QtGui.QPixmap(temp1)
            self.labelImg1.setPixmap(qImgT)
            self.index=1
...
#        self.position1=value
#        ytest=self.position1/100
#        self.editX.setText(str(self.position1))
#        self.editY.setText(str(ytest))
#        dr=Figure_Canvas()
#        dr.test(X_line1=self.position1/100)
#        graphicscene=QtWidgets.QGraphicsScene()
#        graphicscene.addWidget(dr)
#        self.graphicview.setScene(graphicscene)
#        self.graphicview.show()
